  ...
  // --------------------------------------------- //
    ...
    $("#contact-form").submit(function (event) {
      ...
      $.ajax({
        ...
        setTimeout(function () {
          // Done Functions
          formStatus.removeClass('is-visible');
        ...
        if (!response.ok) {
          ...
          var formErrorStatus = $("#error-form-reply");
          formErrorStatus.addClass('is-visible');
        } else {
          form.addClass('is-hidden');
          formStatus.addClass('is-visible');
        }
      }).fail(function (jqXHR, textStatus, errorThrown) {
        form.addClass('is-hidden');
        var formStatus = $("#error-form-reply");
        formStatus.addClass('is-visible');
      });
    });
